package imooc.security.asymmetry;
...
//			RSA 公钥和私钥 不能由用户自定义吗？？？
			...
			String publicKey="publicMiyao123";
			byte[] publicKeyByte = publicKey.getBytes();
			String privateKey="privateMiyao123";
			byte[] privateKeyByte = privateKey.getBytes();
			RSAPublicKey rsaPublicKey = new RSAPublicKey(publicKeyByte);
			RSAPrivateKey rsaPrivateKey = (RSAPrivateKey) keyPair.getPrivate();

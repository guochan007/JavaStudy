...
//		三者编码后的结果一样
	...
	// 2 用Apache的common codes实现  需要jar包 commons-codec-1.10.jar
	...
	// 3 用bouncy castle实现 需要jar包 bcprov-jdk15on-149.jar
	public static void bouncyCastleBase64() {
		...
		byte[] dencodeBytes = org.bouncycastle.util.encoders.Base64
				.decode(encodeBytes);
